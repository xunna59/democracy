              ...
              <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse parent show" id="dashboard">
                    ...
                    <li class="nav-item"><a class="nav-link" href="video-upload" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Video Upload</span></div>
                      </a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="reports" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text">Reports</span></div>
                      </a>
                    </li>
                    <!--  <li class="nav-item"><a class="nav-link" href="project-management.html" data-bs-toggle="" aria-expanded="false">
