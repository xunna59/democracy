                    ...
                    <div class="row g-3 justify-content-between align-items-center">
                      <div class="col-12 col-md">
                        <h4 class="text-900 mb-0" data-anchor="data-anchor" id="example">
                          ...
                          if ($roles == 0) {
                            echo ' All Image Uploads ';
                          }else{

                            echo $states. ' ' .'Image Uploads';
                          }
                          ?>
...
?>
  <a href="view?state=<?php print_r ($row['name']); ?>"><li class="list-group-item"><?php  print_r ($row['name']); ?></li></a>
  <?php 
...
echo'<a href="view-post?imgposts='.$lga.'"><li class="list-group-item d-flex justify-content-between align-items-center">
'.$row["lga"].'<span class="badge badge-light-primary rounded-pill">'.$rowscount_value.'</span></li></a>';
