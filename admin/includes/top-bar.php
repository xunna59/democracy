<nav class="navbar navbar-light navbar-top navbar-expand vertical-navbar">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="index.html">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center"><img src="assets/img/icons/logo.png" alt="phoenix" width="32" />
                  <p class="logo-text ms-2 d-none d-sm-block">Democracy</p>
                </div>
              </div>
            </a>
          </div>
          <div class="collapse navbar-collapse">
            <div class="search-box d-none d-lg-block" style="width:25rem;">
              <form class="position-relative" data-bs-toggle="search" data-bs-display="static" method="post" action="search-result">

                <input class="form-control form-control search-input search min-h-auto" type="search" name="search" placeholder="Search Ward" aria-label="Search" /> 
                ...
                <?php 
                          ...
                          // if ($roles == 0) {
                          //   echo ' <input class="form-control form-control search-input search min-h-auto" type="search" value="Admin Observation Panel" placeholder="Search..." aria-label="Search" disabled/> ';
                          // }else{

                          //   echo '<input class="form-control form-control search-input search min-h-auto" type="search" value="'.$states.' Observation Panel"  aria-label="Search" disabled/>';
                          // }
                          ?>
            ...
            <!--   <li class="nav-item dropdown">
              ...
              <a class="nav-link lh-1 px-0 ms-5" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="avatar avatar-l ">
                   <span class="text-1000" data-feather="settings" style="height:30px;width:30px;"></span>
                  </div>
                </a>
                  ...
                  <div class="card bg-white position-relative border-0">
                    <div class="card-body p-0">
                      <div class="text-center pt-4 pb-3">
                        ...
                        <h6 class="mt-2"><?php echo $user->getUserInfo()['email']; ?></h6>
                        <p class="text-danger">
                             <?php 
                    ...
                    <div class="card-footer p-0 border-top">
                      ...
                      <hr />
                      <a href="logout"><div class="btn btn-phoenix-secondary d-flex flex-center w-100 px-3">  <span class="me-2" data-feather="log-out" > </span>Sign out</div></a>
                    </div>
                  </div>
                </div>
              </li>
