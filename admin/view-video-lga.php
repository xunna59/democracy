<?php include('includes/header.php') ?>
    ...
    <label>Uploaded Videos by L.G.A</label>
    <hr>
              <div class="row g-4">
                  ...
                  <!-- card header starts here -->
                    ...
                    <div class="row g-3 justify-content-between align-items-center">
                      <div class="col-12 col-md">
                        <h4 class="text-900 mb-0" data-anchor="data-anchor" id="example">Uploaded Videos by L.G.A <a href="uploads"><small class="text-danger float-end">Go Back</small></a></h4>
                      </div>
...
$qry="SELECT DISTINCT lga FROM videos WHERE state = '$state' ORDER BY lga ASC";
...
<a href="all-videos?vidposts=<?php echo $lga; ?>"><li class="list-group-item d-flex justify-content-between align-items-center"><?php print_r($row["lga"]); ?><span class="badge badge-light-primary rounded-pill"><?php echo $rowscount_value; ?></span></li></a>
