          ...
          <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="index">
              <div class="d-flex align-items-center">
                <div class="d-flex align-items-center"><img src="assets/img/icons/logo.png" alt="Labour Party" width="32" />
                  <p class="logo-text ms-2 d-none d-sm-block">Labour Party</p>
                </div>
              </div>
            </a>
          </div>
                  ...
                  <div class="card bg-white position-relative border-0">
                    <div class="card-body p-0">
                      <div class="text-center pt-4 pb-3">
                        ...
                        <h6 class="mt-2"><?php echo $user->getUserInfo()['name']; ?></h6>
                        <small class="mt-2"><?php echo $user->getUserInfo()['lga']; ?> L.G.A</small><br>
                         <small class="mt-2"><?php echo $user->getUserInfo()['states']; ?> State</small>
                   ...
                   <!--  <div class="overflow-auto scrollbar" style="height: 10rem;">
                    ...
                    <div class="card-footer p-0 border-top">
                     <!--  <ul class="nav d-flex flex-column my-3">
                      ...
                      <hr /> -->
                      <div class="btn btn-phoenix-secondary d-flex flex-center w-100 px-3"><a href="logout">  <span class="me-2" data-feather="log-out" > </span>Sign out</a></div>
                      <div class="my-2 text-center fw-bold fs--2 text-600"><a class="text-600 me-1" href="#!">Labour Party</a></div>
                    </div>
                  </div>
                </div>
              </li>
